  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience effortless dining with Restaurant Booking Engine, your one-stop solution for table reservations and restaurant management. Simplifying dining, one table at a time."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience effortless dining with Restaurant Booking Engine, your one-stop solution for table reservations and restaurant management. Simplifying dining, one table at a time.`}
            </Text>
            <Box
